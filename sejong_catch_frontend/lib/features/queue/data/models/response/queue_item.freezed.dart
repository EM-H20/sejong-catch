...
mixin _$QueueItem {
  ...
  String get type =>
      throw _privateConstructorUsedError; // 'food', 'drink', 'game', 'photo', 'other'
  String get status =>
      throw _privateConstructorUsedError; // 'active', 'paused', 'full'
  int get waiting => throw _privateConstructorUsedError; // 대기 인원
  int get currentNumber => throw _privateConstructorUsedError; // 현재 순번
  int get avgWaitTime => throw _privateConstructorUsedError;
      ...
      _value.copyWith(
            ...
            currentNumber: null == currentNumber
                ...
                : currentNumber // ignore: cast_nullable_to_non_nullable
                      as int,
            avgWaitTime: null == avgWaitTime
                ? _value.avgWaitTime
                : avgWaitTime // ignore: cast_nullable_to_non_nullable
                      as int,
          )
          as $Val,
    );
...
class _$QueueItemImpl implements _QueueItem {
  ...
  @override
  String toString() {
    return 'QueueItem(id: $id, name: $name, type: $type, status: $status, waiting: $waiting, currentNumber: $currentNumber, avgWaitTime: $avgWaitTime)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.avgWaitTime, avgWaitTime) ||
...
abstract class _QueueItem implements QueueItem {
  const factory _QueueItem({
    ...
    required final int avgWaitTime,
  }) = _$QueueItemImpl;
  ...
  String get name;
  @override
  String get type; // 'food', 'drink', 'game', 'photo', 'other'
  @override
  String get status; // 'active', 'paused', 'full'
  @override
  int get waiting; // 대기 인원
  @override
