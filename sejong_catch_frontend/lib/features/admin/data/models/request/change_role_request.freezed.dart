...
abstract class $ChangeRoleRequestCopyWith<$Res> {
  factory $ChangeRoleRequestCopyWith(
    ChangeRoleRequest value,
    $Res Function(ChangeRoleRequest) then,
...
abstract class _$$ChangeRoleRequestImplCopyWith<$Res>
    implements $ChangeRoleRequestCopyWith<$Res> {
  factory _$$ChangeRoleRequestImplCopyWith(
    _$ChangeRoleRequestImpl value,
...
class __$$ChangeRoleRequestImplCopyWithImpl<$Res>
  ...
  __$$ChangeRoleRequestImplCopyWithImpl(
    _$ChangeRoleRequestImpl _value,
...
class _$ChangeRoleRequestImpl implements _ChangeRoleRequest {
  const _$ChangeRoleRequestImpl({required this.role});
  ...
  @override
  String toString() {
    return 'ChangeRoleRequest(role: $role)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$ChangeRoleRequestImplToJson(this);
  }
}

abstract class _ChangeRoleRequest implements ChangeRoleRequest {
  const factory _ChangeRoleRequest({required final String role}) =
      _$ChangeRoleRequestImpl;
